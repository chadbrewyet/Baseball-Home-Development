...
async function createAssociatedRecord(type,name,email=""){
  ...
  if(type==="superUser"){
    ...
    else await ClubhouseDB.put("invitations",{id:ClubhouseDB.id("invite"),email:normalized,name,recordType:"superUser",role:"Super User",status:"pending",invitedBy:currentUser.id,created:now});
    return;
